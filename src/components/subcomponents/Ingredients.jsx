...
export default function Ingredients() {
    return (
        <Box p={4}>
            <Heading size="md" color="#fff">People Serving (4)</Heading>
            ...
            {["bacon", "eggs"].map((item) => {
                ...
                return <>
                    <Heading size="sm" color="#fff">For the {item}</Heading>
                    <br /><Stack spacing={3}>
                        ...
                        {[{ ingredient: "Bacon", img: "bacon", qty: "3 pieces" }, { ingredient: "Butter", img: "butter", qty: "1 lb" }, { ingredient: "Eggs", img: "eggs", qty: "4 medium" }, { ingredient: "Tomato", img: "tomato", qty: "1/2 medium" }, { ingredient: "Capsicum", img: "capsicum", qty: "1 medium" }].map(food => {
                            return (
                                <Flex alignItems="center" color="#fff" justifyContent="space-between">
